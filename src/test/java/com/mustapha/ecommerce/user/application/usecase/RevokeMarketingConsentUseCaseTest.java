...
@DisplayName("RevokeMarketingConsent Use Case Tests")
class RevokeMarketingConsentUseCaseTest {
    ...
    private RevokeMarketingConsentCommand command;
    ...
    void setUp() {
        ...
        testUser.giveMarketingConsent();
        testUser.clearDomainEvents();

        command = new RevokeMarketingConsentCommand(testUser.getId());
    }

    @Test
    @DisplayName("Should revoke marketing consent successfully")
    void shouldRevokeMarketingConsent() {
        ...
        User result = revokeMarketingConsentUseCase.execute(command);
    ...
    void shouldThrowWhenUserNotFound() {
        ...
        assertThatThrownBy(() -> revokeMarketingConsentUseCase.execute(command))
