...
/**
 * Get Worst Selling Products Query
 * Responsibility: Transfer query parameters from API to Application layer
 * Pattern: Query (CQS - Command Query Separation)
 */
public class GetWorstSellingProductsQuery {
    
    private final int limit;
    private final LocalDate startDate;
    private final LocalDate endDate;
    
    public GetWorstSellingProductsQuery(int limit, LocalDate startDate, LocalDate endDate) {
        this.limit = limit;
