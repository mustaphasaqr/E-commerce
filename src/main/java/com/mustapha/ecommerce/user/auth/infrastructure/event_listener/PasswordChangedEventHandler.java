...
public class PasswordChangedEventHandler {
    ...
    public PasswordChangedEventHandler(RefreshTokenRepository refreshTokenRepository) {
    ...
    public void handle(PasswordChangedEvent event) {
        ...
        try {
            ...
            // Note: Current session remains active (UX consideration)
            // User doesn't get logged out immediately
            // But they won't be able to refresh their JWT after it expires
