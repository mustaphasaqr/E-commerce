package com.mustapha.ecommerce.ecommerce.order.application.usecase;

import org.springframework.stereotype.Component;
import org.springframework.transaction.annotation.Transactional;

import com.mustapha.ecommerce.ecommerce.order.application.port.InventoryPort;
import com.mustapha.ecommerce.ecommerce.order.application.strategy.PaymentStrategy;
import com.mustapha.ecommerce.ecommerce.order.application.strategy.PaymentStrategyFactory;
import com.mustapha.ecommerce.ecommerce.order.application.validation.OrderValidator;
import com.mustapha.ecommerce.ecommerce.order.domain.model.Order;
import com.mustapha.ecommerce.ecommerce.order.domain.model.OrderBuilder;
